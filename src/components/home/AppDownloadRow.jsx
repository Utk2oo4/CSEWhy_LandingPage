...
export default function AppDownloadRow() {
  return (
    <div className="app-download-row">
      <div className="app-info">
        ...
        <div>
          <div className="app-text-title">Learn on the CSEWhy App</div>
          <div className="app-text-subtitle">Access everything anytime, anywhere.</div>
        </div>
      </div>
